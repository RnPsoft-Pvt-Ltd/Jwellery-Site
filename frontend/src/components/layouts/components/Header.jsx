        ...
        {user ? (
          <div className="flex items-center gap-4">
            ...
            <svg width="51" height="30" viewBox="0 0 51 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M28.0013 28.3337C33.9844 28.3337 38.8346 23.4834 38.8346 17.5003C38.8346 11.5172 33.9844 6.66699 28.0013 6.66699C22.0182 6.66699 17.168 11.5172 17.168 17.5003C17.168 23.4834 22.0182 28.3337 28.0013 28.3337Z" stroke="white" strokeWidth="2.5" strokeLinejoin="round"/>
